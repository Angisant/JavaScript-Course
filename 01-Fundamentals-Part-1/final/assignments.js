...
language = "portuguese";
const countryC = "Portugal";
const continentC = "Europe";
const isIslandC = false;

//isIslandC = true;   // error
...
console.log(
  "Does Portugal have a bigger population than Finland?",
  population > finlandPopulation,
);

let avgPopulation = 33;
console.log(
  "Does Portugal have a less than average population?",
...
if (population > avgPopulation) {
  console.log(
    `${country}'s population is ${avgPopulation - population} million below average`,
  );
}
...
const countrySpeaksEnglish = language === "english";
const countryPopulationLessThan50Mil = population < 50;

if (countrySpeaksEnglish && countryPopulationLessThan50Mil && !isIsland) {
...
"Portugal's population is above average". Otherwise, simply log "Portugal's population is below average". Notice how only one word 
...
console.log(
  `${country}'s population is ${population >= avgPopulation ? "above" : "bellow"} average`,
);
